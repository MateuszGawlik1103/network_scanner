...
docker run --detach --publish 8090:9392 -e SKIPSYNC=true -e EMAIL_PASS="$env:EMAIL_PASS" -e EMAIL=$env:EMAIL --name scanner ghcr.io/mateuszgawlik1103/net-scanner-ghcr:latest
